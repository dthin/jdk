    ...
    implements Comparable<ByteBuffer>
{
    ...
    /**偏移量，position在数组中的位置为position+offset*/
    final int offset;
    /**是否只读*/
     ...
     *
     *           this.position = 0
     *           this.limit = this.capacity = array.length
     *           this.offset = 0
     *           this.hb = array
     *
     */
     ...
     * @return  The new byte buffer
     *
     * 创建一个新的buffer，新buffer和旧buffer公用同一个缓冲
     * 新buffer的position为旧buffer的position
     * 新buffer的limit和capacity为旧buffer的limit-position
     */
