 ...
 * @since 1.4
 *
 * 1.如果线程在channel上阻塞，另外一个线程调用了channel的close方法，
 *   会导致阻塞在channel上的线程接收到一个AsynchronousCloseException。
 * 2.如果线程在channel上阻塞，另外一个线程调用该线程的interrupt方法，
 * 会导致channel关闭，阻塞的线程接收到ClosedByInterruptException。
 *
 *
    ...
    implements Channel, InterruptibleChannel
{
     ...
     *
     *          确保其他在i/o操作中阻塞的线程收到回复（抛异常，或返回特定的值）
     */
     ...
     *
     * <p> This method should be invoked in 2111 with the {@link #end end}
