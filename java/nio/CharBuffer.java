    ...
    implements Comparable<CharBuffer>, Appendable, CharSequence, Readable
{
     ...
     *
     *          返回new HeapCharBuffer，limit=offset+length，position=offset
     *
     */
     ...
     *
     *  将此buffer的内容写入target
     *  写入的字节数为 t=min（target.remaining,this.remaining）
     *  此buffer的position+=t
     */
     ...
     * @return  The new char buffer
     *
     *  返回一个新CharBuffer，与旧CharBuffer公用同一个缓冲区
     *  新CharBuffer为旧CharBuffer的position->limit
     */
