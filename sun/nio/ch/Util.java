...
public class Util {
    ...
    static void erase(ByteBuffer var0) {
        unsafe.setMemory(((DirectBuffer)var0).address(), (long)var0.capacity(), 0);
    }
        ...
        AccessController.doPrivileged(new PrivilegedAction() {
            public Void run() {
                try {
                    ...
                    Constructor var2 = var1.getDeclaredConstructor(new Class[]{Integer.TYPE, Long.TYPE, FileDescriptor.class, Runnable.class});
    ...
    static MappedByteBuffer newMappedByteBufferR(int var0, long var1, FileDescriptor var3, Runnable var4) {
        ...
        try {
            MappedByteBuffer var5 = (MappedByteBuffer)directByteBufferRConstructor.newInstance(new Object[]{new Integer(var0), new Long(var1), var3, var4});
            return var5;
        } catch (IllegalAccessException | InvocationTargetException | InstantiationException var7) {
            throw new InternalError(var7);
        }
